var mainarea = "Franklin County";
var mode = "prod";
var zillowReviewsEnabled = false;
var zillowscreenname = null;
var diamondSearchAll = true;
var improvePics = true;
var makeOfferForm = true;
var maincity = "";
maincity = mainarea;
if (zillowscreenname > 0) {
  zillowReviewsEnabled = true;
}
var a_x092969 = false;
...
if (!a_x092969) {
  ...
  style.innerHTML = '.lux-theme {display:none;}';
...
// If permitted
  ...
  style = document.createElement('style');
  style.innerHTML = '.basic-theme {display:none;}';
  document.querySelector('head').append(style);
